...
file_path = r"D:\1. KÌ 1 NĂM 3\1. KHO VÀ KHAI PHÁ DỮ LIỆU\4. CUỐI KÌ\1. DATA\2. DATA KẾT QUẢ\KETQUA_PHANTICH\APRIORI_FINAL.xlsx"
...
data['Factors'] = data['Factors'].apply(lambda x: [item.strip().lower() for item in x]) 
